...
import nl.tudelft.jpacman.game.Point;
    ...
    private void makeGrid(char[][] map, int width, int height, Square[][] grid, List<NPC> ghosts,
        ...
        for (int x = 0; x < width; x++) {
            for (int y = 0; y < height; y++) {
                ...
                addSquare(grid, ghosts, startPositions, p, c);
            }
        }
    }

    private void addSquare(Square[][] grid, List<NPC> ghosts, List<Square> startPositions, Point p, char c) {
